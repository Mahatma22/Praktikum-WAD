        ...
        <div class="container">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row['id']
                    . "</td><td>" . $row['nama_mobil']
                    . "</td><td>" . $row['brand_mobil']
                    . "</td><td>" . $row['warna_mobil']
                    . "</td><td>" . $row['tipe_mobil']
                    . "</td><td>" . $row['harga_mobil']
                    . "</td><td><a href='form_detail_mobil.php?id="
                    . $row['id'] . "' class='btn btn-primary' id='detail'>Detail</a></td></tr>";
                }
                echo "</tbody></table>";
